...
def normalize_query(query):
    reemplazos = {'dermatólogo':'médico', 'pediatra':'médico', 'community manager':'publicidad y mercadeo', 'marketing':'publicidad y mercadeo','cto': 'gerente de tecnología y programación', 'ceo': 'gerente ejecutivo general', 'cfo': 'gerente de finanzas', 'cgo': 'gerente de crecimiento, relaciones y ventas', 'chef':'gastronomo', 'cocinero':'gastronomo','culinario':'gastronomo','gestor de transito aereo':'controlador aereo', 'project manager':'gestor de proyectos'}
